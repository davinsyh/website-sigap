...
(function () {
  ...
  function closeModals() {
    // Close chatbot modal
    const chatbotOverlay = document.querySelector(
    ...
    const activeModals = document.querySelectorAll(
      '.modal.active, [role="dialog"][aria-hidden="false"]',
    );
  ...
  function handleTabKey(e) {
    ...
    const activeModal = document.querySelector(
      '.chatbot-modal-overlay.active .chatbot-modal, [role="dialog"][aria-hidden="false"]',
    );
  ...
  function handleEnterOnCards(e) {
    ...
    if (
      target.matches('.card[tabindex], .blog-card[tabindex], [role="button"]')
    ) {
      e.preventDefault();
      target.click();
    }
  ...
  function handleArrowNavigation(e) {
    ...
    const items = list.querySelectorAll(
      '[role="option"], [role="menuitem"], .nav-item',
    );
